  ...
  - block: markdown
    ...
    content:
      ...
      text: |-
        ...
        这条主线连接三个方向。首先，我研究**以智能体为中心的机器人学习**，通过可复用技能和持久经验实现局部适应，而不必每次重训完整策略。其次，我将**大语言模型（LLM）**、**视觉语言模型（VLM）**与**视觉-语言-动作模型（VLA）**连接起来，并引入声音、本体感觉和记忆，使模型推理始终落在真实物理交互中。最后，我研究**鲁棒感知与具身数据生成**，从学习式采样一致性到机器人多视角轨迹的一致编辑。
