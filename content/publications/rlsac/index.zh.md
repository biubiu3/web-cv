...
鲁棒估计需要从大量外点中选出一个全内点最小集。RANSAC 反复随机采样、拟合假设，并保留共识最大的结果。RLSAC 利用已测试假设的残差与采样历史，学习下一轮应选择哪些观测。
...
RLSAC 将最小集作为动作，将几何共识作为反馈，并用采样历史指导后续选择。观察结果、保存经验、调整下一次行为，也是我后续多模态与机器人研究关注的问题。
